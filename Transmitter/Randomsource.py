...
class Randomsource(gr.top_block, Qt.QWidget):

    def __init__(self, InFile=''):
        gr.top_block.__init__(self, "Randomsource")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Randomsource")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Randomsource")
        ...
        self.limesdr_sink_0.set_center_freq(433000000, 0)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2, 48000))), True)
        ...
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=Randomsource, options=None):
    if options is None:
